...
struct fit_record_data record_data[] = {
    ...
    DATA_RECORD(struct fit_record, distance,         5, 1/100000.0, "km", TYPE_UINT32),
...
struct fit_record_data session_data[] = {
    ...
    DATA_RECORD(struct fit_session, total_distance,      9, 1/100000.0, "km", TYPE_UINT32),
...
struct fit_record_data lap_data[] = {
    ...
    DATA_RECORD(struct fit_lap, total_distance,      9, 1/100000.0, "km", TYPE_UINT32),
